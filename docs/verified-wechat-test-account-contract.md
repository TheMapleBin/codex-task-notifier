...
- 2026-07-28 因测试号卡片截断长变量且不能展开，用户决定生产切回 iLink；2026-07-29 生产继续迁移到 QQ Bot，测试号配置保留备用。
- 切换测试号：`commands/use-wechat-test-account.cmd`。
- 回滚直接 iLink：`commands/use-ilink.cmd`。
